            ...
            <div className="max-w-2xl mx-auto mb-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="bg-white border border-neutral-200 rounded-lg p-4">
                  <div className="text-sm text-text-tertiary mb-1">{cbiSections.personal.name_zh}</div>
                  <div className="text-2xl font-bold text-primary-600">{personalScore}</div>
                </div>
                <div className="bg-white border border-neutral-200 rounded-lg p-4">
                  <div className="text-sm text-text-tertiary mb-1">{cbiSections.work.name_zh}</div>
                  <div className="text-2xl font-bold text-warning-600">{workScore}</div>
                </div>
                <div className="bg-white border border-neutral-200 rounded-lg p-4">
                  <div className="text-sm text-text-tertiary mb-1">{cbiSections.client.name_zh}</div>
  ...
  return (
    <Card>
      <div className="max-w-4xl mx-auto">
        <h2 className="text-heading-2 text-text-primary font-bold mb-2">Copenhagen Burnout Inventory (CBI)</h2>
                  ...
                  {sectionQuestions.map((question, idx) => (
                    <div key={question.id} className="pb-6 border-b border-neutral-100 last:border-b-0">
                      <div className="text-sm font-medium text-text-primary mb-3">
                        <span className="inline-block w-6 h-6 rounded-full bg-primary-100 text-primary-600 text-sm flex items-center justify-center mr-2">
                          {idx + 1}
                        </span>
                        {question.text_zh}
                      </div>
                      <div className="text-sm text-text-tertiary mb-3 italic pl-8">
                        {question.text}
                      </div>
