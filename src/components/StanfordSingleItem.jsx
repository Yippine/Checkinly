      ...
      <>
        <Card>
          <div className="text-center py-8">
            ...
            <h1 className="text-heading-2 text-text-primary font-bold mb-2">
              評估完成
            </h1>
  ...
  return (
    <Card>
      <div className="max-w-3xl mx-auto">
        <h2 className="text-heading-2 text-text-primary font-bold mb-2">
          Stanford 單題倦怠評估
        </h2>
        ...
        <div className="mb-8 p-6 bg-neutral-50 border border-neutral-200 rounded-lg">
          <div className="text-body font-medium text-text-primary mb-4">
            {stanfordQuestion.text_zh}
          </div>
          <div className="text-sm text-text-tertiary mb-4 italic">
            ...
            {stanfordQuestion.options.map((option) => (
              ...
              >
                ...
                <div className="ml-3 flex-1">
                  ...
                  <span className="ml-2 text-sm text-text-tertiary italic">
                    ({option.label})
                  </span>
                </div>
